...
<div className='bg-black'>
  ...
  <aside>
    <div>
        <img className='w-1/12 ml-2' src={Logo} alt="Logo" />
    </div>
    <h4>GoalFlow.io <br /><span className='text-xs'>Stay organized. Stay moving.</span></h4>
  </aside>
  <nav>
    ...
    <div className=' border-t-1 border-gray-600 block w-full pb-2 mx-auto'>
